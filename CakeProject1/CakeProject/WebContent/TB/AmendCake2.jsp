<%@page import="com.service.impl.CakeService"%>
<%@page import="com.service.ICakeService"%>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel">
								...
								Cake cake=cservice.selectCakeById(id);
								
								%>
								<div class="panel-body" style="width: 50%;">
									<form method="post" enctype="multipart/form-data" action="../AmendCakeServlet?id=<%=cake.getC_id()%>" >
										<div class="form-group">
											<label for="exampleInputName">商品名称：</label> <input
												type="text" class="form-control" name="cakename"
												value="<%=cake.getC_name()%>">
										</div>
										<div class="form-group">
											<label for="exampleInputName">商品价格：</label> <input
											type="text" class="form-control" 
											name="cakeprice" value="<%=cake.getC_price()%>">
										</div>
										<div class="form-group">
											<label for="exampleInputName">商品类别：</label> <input
											type="text" class="form-control" 
											name="caketype" value="<%=cake.getC_type()%>">
										</div>
										<div class="form-group">
											<label for="exampleInputName">商品重量：</label> <input
											type="text" class="form-control" 
											name="cakeweight" value="<%=cake.getC_weight()%>">
										</div>
										<div class="form-group">
											<label for="exampleInputName">商品口味：</label> <input
											type="text" class="form-control" 
											name="caketaste" value="<%=cake.getC_taste()%>" >
										</div>
										<div class="form-group">
											<label for="exampleInputName">商品颜色：</label> <input
											type="text" class="form-control" 
											name="cakecolor" value="<%=cake.getC_color()%>" >
										</div>
										<div class="form-group">
											<label for="exampleInputName">商品介绍 ：</label> <input
											type="text" class="form-control" 
											name="cakeintroduce" value="<%=cake.getC_introduce()%>">
										</div>
										<div class="form-group">
											<label for="exampleInputName">商品描述 ：</label> <input
											type="text" class="form-control" 
											name="cdescription" value="<%=cake.getC_description()%>">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="exampleInputFile">商品图片：</label> <input
												type="file" name="cakeimg" value="<%=cake.getC_image()%>">
										</div>
										<div class="col-sm-4">
<!-- 										AmendCakeServlet?id=ck.getC_id() -->
