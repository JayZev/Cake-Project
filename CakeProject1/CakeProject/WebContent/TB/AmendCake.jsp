						...
						<li>
							...
							<div id="subPages" class="collapse in">
								<ul class="nav">
									...
									<li><a href="AmendCake.jsp" class="active">修改商品</a></li>
...
out.println("<tr><td style='vertical-align: middle'>蛋糕编号</td><td style='vertical-align: middle'>蛋糕名称</td>"+
			...
			"<td style='vertical-align: middle'>蛋糕状态</td><td style='vertical-align: middle'>操作</td></tr>");
											for (int i = 0; i < list.size(); i++) {
												...
												out.println("<td style='vertical-align: middle'><button  class='btn btn-success' onClick='javascript:window.location.href=\"AmendCake2.jsp?id="+ck.getC_id()+"\"'>修改</button></td>");
												out.print("</tr>");
											}
										%>
									</table>
									<p>
										<button type="button" class="btn btn-default" onclick="location.href='AmendCake.jsp?pageid=<%=previd%>'">上一页</button>
											<%
												for (int i = 1; i < cake2.getPageNum()+1; i++) {
											%>
												
												<button type="button" class="btn btn-default" onclick="location.href='AmendCake.jsp?pageid=<%=i %>'"><%=i %></button>
											<%
												}
											%>
								
										<button type="button" class="btn btn-default" onclick="location.href='AmendCake.jsp?pageid=<%=nextid%>'">下一页</button>
										</p>
								</div>
							</div>
						</div>
