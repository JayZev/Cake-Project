					...
					<ul class="nav">
						...
						<li><a href="#subPages1" data-toggle="collapse" class="active"><i class="lnr lnr-dice"></i> <span>订单信息</span><i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages1" class="collapse in">
								<ul class="nav">
									<li><a href="Sell.jsp" class="active">历史订单信息</a></li>
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">订单信息</h3>
						<form id="fm" class="form-horizontal" method="post" action="Sell2.jsp">
						</form>		
					<div class="row">
						<div class="col-md-12">
							<div class="panel">
								...
								<div class="panel-body" style="width: 100%" >
									...
									<table class="table table-striped"  >
										<%	
											...
											if (nextid > sell2.getPageNum()) {
												nextid = sell2.getPageNum();
											}
											int k = 0;
											if(pageid=="1"){
												k = 1;
											...
											List<SellList> list = sell2.getDataByPageNumber(pid);
out.println("<tr><td style='vertical-align: middle'>编号</td><td style='vertical-align: middle'>收件人</td><td style='vertical-align: middle'>收件人地址</td>"+											
			...
			"<td style='vertical-align: middle'>联系方式</td><td style='vertical-align: middle'>预计送达时间</td><td style='vertical-align: middle'>实际送达时间</td>"+
			"<td style='vertical-align: middle'>商品状态</td></tr>");
											for (int i = 0; i < list.size(); i++) {
												...
												out.println("<td style='vertical-align: middle'>"+sl.getS_actual()+"</td>");
									...
									<p>
										<button type="button" class="btn btn-default" onclick="location.href='Sell.jsp?pageid=<%=previd%>'">上一页</button>
											<%
												for (int i = 1; i < sell2.getPageNum()+1; i++) {
											%>
												
												<button type="button" class="btn btn-default" onclick="location.href='Sell.jsp?pageid=<%=i %>'"><%=i %></button>
											<%
												}
											%>
										...
										<button type="button" class="btn btn-default" onclick="location.href='Sell.jsp?pageid=<%=nextid%>'">下一页</button>
										</p>
								</div>
							</div>
						</div>
