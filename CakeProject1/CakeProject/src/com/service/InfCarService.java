...
public interface InfCarService {
	 ...
	 * @return			更新的数量
	 */
	boolean updateCarByCarId(int car_id, int num);
	/**
	 * 根据购物车信息编号
	 * @param car_id	购物信息编号
	 * @return	删除的条目数
	 */
	boolean delteCarByCarId(int car_id);
	/**
	 * 查询购物车中数量最多的前top个
	 * @param top	数目
	 ...
	 * @return			影响的条目数
	 */
	boolean addCarNumByCarId(int car_id, int num);
	/**
	 * 通过购物车编号查询购物车信息
	 * @param car_id	购物车编号
	 * @return			购物车信息s
